...
class CreateBackupStatementsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('backup_statements')) {
            Schema::create('backup_statements', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('backup_statements');
    }
}
